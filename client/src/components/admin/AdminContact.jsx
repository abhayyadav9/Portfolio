...
const AdminContact = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://abhay-portfolio-orpin.vercel.app/api/v3/contact/getcontact', {
  ...
  const handleAddContact = async (e) => {
    ...
    try {
      await axios.post('https://abhay-portfolio-orpin.vercel.app/api/v3/contact/addcontact', formData, {
        headers: {
      ...
      setFile(null);
      const response = await axios.get('https://abhay-portfolio-orpin.vercel.app/api/v3/contact/getcontact', {
        withCredentials: true
      });
  ...
  const handleEditContact = async (e) => {
    ...
    try {
      await axios.put(`https://abhay-portfolio-orpin.vercel.app/api/v3/contact/editcontact/${editContactId}`, formData, {
        headers: {
          'Content-Type': 'multipart/form-data'
        },
        withCredentials: true
  ...
  const handleDeleteContact = async (contactId) => {
    try {
      await axios.delete(`https://abhay-portfolio-orpin.vercel.app/api/v3/contact/deletecontact/${contactId}`, {
        withCredentials: true
      });
      // Refetch contacts
      const response = await axios.get('https://abhay-portfolio-orpin.vercel.app/api/v3/contact/getcontact', {
