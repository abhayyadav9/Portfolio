...
const AddProject = () => {
  ...
  const fetchProjects = async () => {
    try {
      const response = await axios.get('https://portfolio-servers.onrender.com/api/v2/project/getprojects', {
  ...
  const handleAddProject = async () => {
    ...
    try {
      const response = await axios.post('https://portfolio-servers.onrender.com/api/v2/project/addproject', formData, {
        headers: {
