...
const AddProject = () => {
  ...
  const fetchProjects = async () => {
    try {
      const response = await axios.get('https://abhay-portfolio-orpin.vercel.app/api/v2/project/getprojects', {
  ...
  const handleAddProject = async () => {
    ...
    try {
      const response = await axios.post('https://abhay-portfolio-orpin.vercel.app/api/v2/project/addproject', formData, {
        headers: {
