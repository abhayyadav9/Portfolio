...
const Navbar = () => {
  ...
  return (
    <div
      ...
      } shadow-sm sticky w-full top-0 z-50 shadow-md bg-gradient-to-b from-purple-40 to-purple-90`}
    >
      <div className="flex items-center justify-between mx-auto max-w-7xl h-16 px-4">
        <div className="mr-4">
          <h1 className="text-2xl font-bold">
            ...
            <span className="text-[#F83002]"> Yadav</span>
          </h1>
        </div>
        <div className={`flex items-center gap-8 ${isDarkMode ? "text-white" : "text-gray-900"}`}>
          <ul className={`flex font-medium items-center gap-5 ${isDarkMode ? "text-white" : "text-gray-900"}`}>
            <li>
              <Link
                to="/"
